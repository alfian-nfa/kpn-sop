...
// node_modules/datatables.net-bs5/node_modules/datatables.net/js/dataTables.mjs
...
var dataTables_default2 = DataTable;

// node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs
var $2 = import_jquery2.default;
$2.extend(true, dataTables_default2.defaults, {
  renderer: "bootstrap"
});
$2.extend(true, dataTables_default2.ext.classes, {
...
var dataTables_bootstrap5_default = dataTables_default2;
...
(function() {
  ...
  setJQuery($3);
  $3.fn.dataTable.FixedColumns = FixedColumns;
  $3.fn.DataTable.FixedColumns = FixedColumns;
  ...
  dataTables_default.ext.buttons.fixedColumns = {
    action: function(e, dt, node, config) {
      if ($3(node).attr("active")) {
        $3(node).removeAttr("active").removeClass("active");
        dt.fixedColumns().start(0);
        dt.fixedColumns().end(0);
      } else {
        $3(node).attr("active", "true").addClass("active");
  ...
  $3(document).on("plugin-init.dt", function(e, settings) {
    if (e.namespace !== "dt") {
      return;
    }
